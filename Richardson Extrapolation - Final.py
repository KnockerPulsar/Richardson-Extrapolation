...
def TableDeriv(x, Xlist, Ylist):
    ...
    points = Xlist.size #Gets the length of the Xlist array and therefore the number of points entered. I know I could've made the input function return it but I didn't want to screw over the interface team.
    
    try:
        index = np.where(Xlist == x)[0][0] #Finds the index of the input point for the derivative
